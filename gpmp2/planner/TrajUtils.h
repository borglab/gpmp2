 ...
 */
GPMP2_EXPORT gtsam::Values initArmTrajStraightLine(
    const gtsam::Vector& init_conf, const gtsam::Vector& end_conf,
    size_t total_step);
 ...
 * @return values, x(0) - x(total_step), v(0) - v(total_step)
 */
GPMP2_EXPORT gtsam::Values initPose2VectorTrajStraightLine(
    const gtsam::Pose2& init_pose, const gtsam::Vector& init_conf,
    const gtsam::Pose2& end_pose, const gtsam::Vector& end_conf,
    size_t total_step);
 ...
 * @return values, x(0) - x(total_step), v(0) - v(total_step)
 */
GPMP2_EXPORT gtsam::Values initPose2TrajStraightLine(
    const gtsam::Pose2& init_pose, const gtsam::Pose2& end_pose,
    size_t total_step);
 ...
 * @param output_inter_step is how many steps you want interpolate, 0 is not
 * interpolate
 * @return interpolated values, x(0) - x(total_step), v(0) - v(total_step)
 */
GPMP2_EXPORT gtsam::Values interpolateArmTraj(
    const gtsam::Values& opt_values, const gtsam::SharedNoiseModel Qc_model,
    double delta_t, size_t output_inter_step);
 ...
 * @return interpolated values, x(start_index) - x(end_index), v(start_index) -
 * v(end_index)
 */
GPMP2_EXPORT gtsam::Values interpolateArmTraj(
    const gtsam::Values& opt_values, const gtsam::SharedNoiseModel Qc_model,
    double delta_t, size_t output_inter_step, size_t start_index,
    size_t end_index);
 ...
 * v(end_index)
 */
GPMP2_EXPORT gtsam::Values interpolatePose2MobileArmTraj(
    const gtsam::Values& opt_values, const gtsam::SharedNoiseModel Qc_model,
 ...
 * v(end_index)
 */
GPMP2_EXPORT gtsam::Values interpolatePose2Traj(
    const gtsam::Values& opt_values, const gtsam::SharedNoiseModel Qc_model,
    double delta_t, size_t inter_step, size_t start_index, size_t end_index);
}  // namespace gpmp2
