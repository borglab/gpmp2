...
struct GPMP2_EXPORT TrajOptimizerSetting {
  ...
  gtsam::SharedNoiseModel
      conf_prior_model;  // prior constraint model for initial/end state
  gtsam::SharedNoiseModel
      vel_prior_model;  // prior constraint model for initial/end velocity
  ...
  gtsam::Vector joint_pos_limits_up,
      joint_pos_limits_down;  // joint position limits, if Pose2Vector, only
                              // Vector part
