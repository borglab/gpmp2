 ...
 *  @brief  Gaussian prior defined on the workspace orientation of any joint of
 *a robot given its state in configuration space
...
class GaussianPriorWorkspaceOrientation
 ...
 public:
  ...
  /// Constructor
  GaussianPriorWorkspaceOrientation(gtsam::Key poseKey, const Robot& robot,
                                    int joint,
