 ...
 *  @brief  Gaussian prior defined on the workspace Orientation of any link of
 *an arm given its state in configuration space
...
typedef GaussianPriorWorkspaceOrientation<ArmModel>
