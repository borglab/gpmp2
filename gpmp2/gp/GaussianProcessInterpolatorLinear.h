...
class GaussianProcessInterpolatorLinear {
 ...
 public:
  ...
  void print(const std::string& s = "") const {
    std::cout << s << "GaussianProcessInterpolatorLinear(" << dof_ << ")"
              << std::endl;
...
namespace gtsam {
template <>
struct traits<gpmp2::GaussianProcessInterpolatorLinear>
    : public Testable<gpmp2::GaussianProcessInterpolatorLinear> {};
}  // namespace gtsam
