...
TEST(GaussianProcessInterpolatorLinear, equals) {
  ...
  noiseModel::Gaussian::shared_ptr Qc2_model =
      noiseModel::Gaussian::Covariance(Qc2);
...
TEST(GaussianProcessInterpolatorLinear, interpolatePose) {
  ...
  expectH1 = numericalDerivative11(
      std::function<Vector3(const Vector3&)>(
          boost::bind(&GPBase::interpolatePose, base, _1, v1, p2, v2,
                      boost::none, boost::none, boost::none, boost::none)),
      p1, 1e-6);
  expectH2 = numericalDerivative11(
      std::function<Vector3(const Vector3&)>(
          boost::bind(&GPBase::interpolatePose, base, p1, _1, p2, v2,
                      boost::none, boost::none, boost::none, boost::none)),
      v1, 1e-6);
  expectH3 = numericalDerivative11(
      std::function<Vector3(const Vector3&)>(
          boost::bind(&GPBase::interpolatePose, base, p1, v1, _1, v2,
                      boost::none, boost::none, boost::none, boost::none)),
      p2, 1e-6);
  expectH4 = numericalDerivative11(
      std::function<Vector3(const Vector3&)>(
          boost::bind(&GPBase::interpolatePose, base, p1, v1, p2, _1,
                      boost::none, boost::none, boost::none, boost::none)),
      v2, 1e-6);
