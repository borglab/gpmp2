...
TEST(GaussianProcessInterpolatorPose2Vector, interpolatePose) {
  ...
  expectH1 = numericalDerivativeDynamic(
      std::function<Pose2Vector(const Pose2Vector&)>(boost::bind(
          &GaussianProcessInterpolatorPose2Vector::interpolatePose, base, _1,
          v1, p2, v2, boost::none, boost::none, boost::none, boost::none)),
      p1, 1e-6);
  expectH2 = numericalDerivativeDynamic(
      std::function<Pose2Vector(const Vector6&)>(boost::bind(
          &GaussianProcessInterpolatorPose2Vector::interpolatePose, base, p1,
          _1, p2, v2, boost::none, boost::none, boost::none, boost::none)),
      v1, 1e-6);
  expectH3 = numericalDerivativeDynamic(
      std::function<Pose2Vector(const Pose2Vector&)>(boost::bind(
          &GaussianProcessInterpolatorPose2Vector::interpolatePose, base, p1,
          v1, _1, v2, boost::none, boost::none, boost::none, boost::none)),
      p2, 1e-6);
  expectH4 = numericalDerivativeDynamic(
      std::function<Pose2Vector(const Vector6&)>(boost::bind(
          &GaussianProcessInterpolatorPose2Vector::interpolatePose, base, p1,
          v1, p2, _1, boost::none, boost::none, boost::none, boost::none)),
      v2, 1e-6);
