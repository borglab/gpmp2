...
TEST(GPPriorLTILinear, Factor) {
  ...
  /*delta_t = 0.01 */
  //p2 = (Vector3() << -0.0999998780487805, 1.20000036585366, 0.300008771929825).finished();
  //v2 = (Vector3() << 2.4390243902439e-05, 7.31707317073171e-05, 0.00175438596491228).finished();

  /*delta_t = 0.5 */
  p2 = (Vector3() << -0.0996951219512195, 1.20091463414634, 0.321929824561404).finished();
  v2 = (Vector3() << 0.00121951219512195, 0.00365853658536585, 0.087719298245614).finished();
